...
_METHOD_ALIASES = {
    ...
    "unicron_flash_hrr": ("flash as hrr recall from sidecar",
                          "inject holographic memory before generate",
                          "deepseek v4 gateway system inject",
                          "vllm openai attach memory to chat request"),
