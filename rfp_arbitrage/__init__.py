...
teams?), price them from comparable awards, and rank them for delivery through openzoo.
...
Pipeline (each stage is a CLI verb, see `python -m rfp_arbitrage --help`):
    ...
    propose   -> propose        draft the bid from the bound solicitation (openzoo)
...
"""
from .models import Opportunity, ClauseVerdict, Match, Jurisdiction, Tier  # noqa: F401
