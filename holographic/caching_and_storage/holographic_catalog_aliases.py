...
_METHOD_ALIASES = {
    ...
    "unicron_flash_tools": ("sidecar with tool calling", "advertise lecore tools to the model",
                            "tool routes for the sidecar", "execute the model's tool calls",
                            "openai tools from lecore faculties", "recall plus tools in front of vllm"),
